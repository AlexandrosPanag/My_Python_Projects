...
def resize_and_zoom_video(input_path: str, output_path: str, zoom_factor: float = 1.5, y_offset: float = 0.0):
    """
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python video_resizer.py <input_video.webm> [output_video.webm] [zoom_factor] [y_offset]")
        print("\nExample:")
    ...
    resize_and_zoom_video(input_path, output_path, zoom_factor, y_offset)
