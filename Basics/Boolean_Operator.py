...
print(2 == 3) #It will print false because 2 doesnt equal to 3
print(7>7.0) #it will print false because 7 is not bigger from 7,0
print(9 >= 9.0) #it will print true for the same reason as above
